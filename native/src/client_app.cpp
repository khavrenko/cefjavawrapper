...
void ClientApp::OnBeforeChildProcessLaunch(
   ...
   std::string val = cmd.ToString();
	...
	ReplaceStringInPlace( clean_str, "-xms", "-Xms");
	ReplaceStringInPlace( clean_str, "-xmx", "-Xmx");
	ReplaceStringInPlace( clean_str, "-xx", "-XX");
	ReplaceStringInPlace( clean_str, "maxpermsize", "MaxPermSize");
